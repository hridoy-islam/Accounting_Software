...
import { fetchPermissions } from '@/redux/features/permissionSlice'; // ✅ Make sure this path is correct
...
export default function UserAuthForm() {
  ...
  useEffect(() => {
    if (user) {
      ...
      if (['manager', 'user', 'audit'].includes(user.role)) {
        dispatch(fetchPermissions(user.companyId));

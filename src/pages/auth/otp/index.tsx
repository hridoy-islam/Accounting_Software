    ...
    <>
      <div className="container grid h-svh flex-col items-center justify-center bg-primary lg:max-w-none lg:px-0">
        <div className="mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[480px] lg:p-8">
          {/* logo */}
          <div className="flex items-center gap-2 text-[#a78bfa] justify-center pb-4">
          ...
          <Card className="p-6">
                ...
                <div className="container">
                  <div>
                    ...
                    <Button
                      ...
                      className="ml-auto mt-5 w-full bg-black text-white hover:bg-accent"
                      variant="outline"
                    >
                      Verify OTP
                    </Button>
            ...
            <p className="mt-4 px-8 text-center text-sm text-muted">
              ...
              <Link
                to="/sign-up"
                className="text-muted underline underline-offset-4 hover:text-[#a78bfa]"
              >
                Sign up
              </Link>
              .

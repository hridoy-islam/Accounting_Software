      ...
      <div className="container grid h-svh flex-col items-center justify-center bg-primary lg:max-w-none lg:px-0">
        <div className="mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[480px] lg:p-8">
          <div className="mb-4 flex items-center justify-center">
            ...
            <h3 className='text-4xl text-[#a78bfa] font-bold'>LOGO</h3>
          </div>
          <Card className="p-6">
            <div className="mb-2 flex flex-col space-y-2 text-left">
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <Button
                    disabled={loading}
                    className="ml-auto w-full bg-background text-white hover:bg-accent"
                    type="submit"
                  >
                    Reset Password
                  </Button>
            ...
            <p className="mt-4 px-8 text-center text-sm text-muted">
              ...
              <Link to="/signup" className="underline underline-offset-4 hover:text-[#a78bfa]">
                Sign up
              </Link>
              .
            </p>
